...
|---|---|---|---|---|---|
| **Main** — build from reasons, not by eye | **3** · `[INT · Даня · B1 Q3, B4 Q1, B4 Q3]` | `[?]` · construction values never asked (`personas.md` gap 6) | `[?]` | The breakdown travelling with the work: values **plus the author's intent**, intent carried through the case material itself | **partly** — Refero Styles auto-generates the values for 2,000+ sites (`refero-style-breakdown.png`); **nobody carries the intent** `[RES · CONCLUSIONS · H1]` |
